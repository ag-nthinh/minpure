...
//    require_once("login.php");
    ...
    $row = $obj -> getAllAGPromotions($array);
...
<!-- topbar starts -->
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="brand" href="promotions.php"> <img src="img/title.png" height="30"></a>
				<div class="top-nav nav-collapse">
					           <ul class="nav">
							<li><a href="promotions.php?timesale=0">AffiTown広告一覧</a></li>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<!-- content starts -->
			<h2><?php if($array['timesale']){ echo "タイムセール"; } else { echo "AffiTown広告"; } ?>一覧</h2>
...
*/
				...
				<tr<?php if($value['view']==0){ echo ' class="viewoff"'; } ?>>
				    <td class="center"><?php print(htmlspecialchars($value['affitown_advertisement_id'])); ?></td>
				    ...
				    <td class="center"><?php echo $value['img']; ?></td>
                                    ...
                                    <td class="center"><?php print(htmlspecialchars(number_format($value['point'])."DIG"));
