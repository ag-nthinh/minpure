 ...
 */
Class ViewDetail_CN extends CommonBase{
    /*
    コンストラクタ
    */
...
<Tr><Td><p class="point"><img src="img/dig.png" width="27" height="27"><?php echo number_format($p['point']) ?></p></Td></Tr>
...
<p class="shosai">
<?php if($p['note']) { echo nl2br($p['note']); } else { ?>
    タイムラグの関係で表示のポイント付与と実施のポイント付与数に相違が生じる可能性があります。</br >
