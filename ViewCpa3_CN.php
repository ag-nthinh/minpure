 ...
 */
Class ViewCpa3_CN extends CommonBase{
    /*
    コンストラクタ
    */
...
//CreateLog::putErrorLog(" My login_id:".$_GET['login_id']." login_pass:".$_GET['login_pass']." ".Utils::str_encrypt($_GET['login_id']));
CreateLog::putDebugLog("Uresuji login_id:".$_GET['login_id']);

    if(!$p3 = $obj -> getPromotions(array("type"=>3, "timesale"=>0, "status"=>1, "num"=>30, "login_id"=>$_GET['login_id']))){}
