 ...
 */
Class ViewCpa3 extends CommonBase{
    /*
    コンストラクタ
    */
...
<?php 
    if(!$p3 = $obj -> getPromotions(array("type"=>3, "timesale"=>0, "status"=>1, "num"=>100))){}
    //if(!$p3 = $obj -> getPromotions(3,100)){}
...
<Tr><Td><p class="point"><img src="img/pp.png" width="27" height="27"><?php echo $value['point'] ?>P</p></Td></Tr>
