 ...
 */
Class ViewExc2_UM extends CommonBase{
    /*
    コンストラクタ
    */
...
<Td Valign="middle"><a class="inst" href="exchange_um.php?login_id=<?php echo $_GET['login_id'] ?>">交換する</a></Td>
</Table>
...
<Table align="center" height="50">
<Td Valign="middle"><a class="inst2" href="code_um.php?login_id=<?php echo $_GET['login_id'] ?>">ギフトコードの確認</a></Td>
</Table>
