 ...
 */
Class ViewBank_CN extends CommonBase{
    /*
    コンストラクタ
    */
...
<Td Valign="middle"><a class="btnre" href="code_cn.php?login_id=<?php echo $_POST['login_id'] ?>&login_pass=<?php echo $_POST['login_pass'] ?>&version=<?php echo $_POST['version'] ?>">ギフトコード交換履歴を見る</a></Td>
</Table>
...
<?php }  ?>
<Table align="center" height="50">
<Td Valign="middle"><a class="inst" href="exchange_cn.php?login_id=<?php echo $_POST['login_id'] ?>&login_pass=<?php echo $_POST['login_pass'] ?>&version=<?php echo $_POST['version'] ?>">交換する</a></Td>
</Table>
